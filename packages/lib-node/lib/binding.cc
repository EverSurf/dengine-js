...
// function(context: number, functionName: string, functionParamsJson: string): string
napi_value requestSync(napi_env env, napi_callback_info info) {
    size_t argc = 3;
    napi_value args[3];
    CHECK(napi_get_cb_info(env, info, &argc, args, nullptr, nullptr));
    if (argc >= 3) {
...
napi_value init(napi_env env, napi_value exports) {
    napi_property_descriptor properties[6] = {
            {"getLibName", nullptr, getLibName, nullptr, nullptr, nullptr, napi_default, nullptr},
